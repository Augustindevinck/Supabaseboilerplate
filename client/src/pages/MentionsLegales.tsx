      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <Card>
          <CardContent className="pt-6 space-y-4 text-muted-foreground">
            <section>
              <h2 className="text-xl font-bold text-foreground mb-2">1. Éditeur du site</h2>
              <p>Nom de l'entreprise : SaaSify SAS</p>
              <p>Siège social : 123 Rue de la Tech, 75001 Paris, France</p>
              <p>Email : contact@saasify.fr</p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-foreground mb-2">2. Hébergeur</h2>
              <p>Le site est hébergé par Replit Inc.</p>
              <p>Adresse : 85 2nd St, San Francisco, CA 94105, États-Unis</p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-foreground mb-2">3. Propriété intellectuelle</h2>
